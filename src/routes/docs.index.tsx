        ...
        {DOCS.map((doc) => (
          ...
          >
            <div className="flex items-start gap-3">
              <div className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-accent-dim text-accent group-hover:bg-accent group-hover:text-bg transition-colors">

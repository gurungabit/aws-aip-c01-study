# RETEST FOCUS: Security, Governance & Weak Domains Deep Dive

> You scored 735/750. You need 15 more points. D3 (20%), D4 (12%), D5 (11%) all marked "Needs Improvement."
> D3 Security is your **highest-leverage fix** — it's 20% of the exam.
> This guide fills every gap from your first attempt.
...
## PART 4: EXAM STRATEGY FOR YOUR RETEST
...
| **Your score** | 735 (15 points short) |
| **Time** | 180 minutes |
| **Question types** | Multiple choice, multiple response, scenario-based |

### Where Your 15 Points Come From

| Domain | Weight | Your Status | Point Potential |
|--------|--------|-------------|-----------------|
| D3: Security | 20% | Needs Improvement | **HIGH** — biggest bang for study time |
| D4: Ops Efficiency | 12% | Needs Improvement | MEDIUM — know monitoring and cost patterns |
| D5: Testing | 11% | Needs Improvement | MEDIUM — know evaluation frameworks |

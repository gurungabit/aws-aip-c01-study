...
export const questionsV6: Question[] = [
  // ─── Domain 1: FM Integration, Data & Compliance (23 questions, IDs 1–23) ───
  {
    ...
    options: [
      { letter: 'A', text: 'The model\'s context window is too small. Switch to a model with a larger context window.' },
      { letter: 'B', text: 'The maxTokens parameter in the inference configuration is set too low. Increase maxTokens to allow a longer completion.' },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'B', text: 'Enable hybrid search to combine semantic and keyword matching, and add metadata filtering to restrict results by regulation_type.' },
      { letter: 'C', text: 'Increase the number of retrieved chunks from 5 to 50 to improve recall.' },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'B', text: 'Create a .metadata.json file alongside each document in S3 with the filterable attributes. Configure the Knowledge Base data source to use these metadata files.' },
      ...
      { letter: 'D', text: 'Embed the metadata as the first line of each document so it gets included in the chunk embeddings.' }
    ],
    correct: ['B'],
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'B', text: 'Create a separate Amazon Kendra index for keyword search and merge results manually.' },
      { letter: 'C', text: 'Configure metadata filtering to match part numbers as structured attributes.' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Use RAG with the source article as context, set temperature to 0, and include a system prompt instructing the model to only use information from the provided context.' },
      { letter: 'B', text: 'Fine-tune the model on a dataset of article-summary pairs to teach it the correct summarization style.' },
      { letter: 'C', text: 'Increase the maxTokens parameter and set top_p to 0.5 to constrain the output distribution.' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Use Amazon Bedrock continued pre-training with the unlabeled documents stored in S3.' },
      ...
      { letter: 'D', text: 'Use Amazon Bedrock model evaluation to score the model\'s understanding of semiconductor terms.' }
    ],
    correct: ['A'],
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Use Amazon Bedrock Knowledge Base hybrid search that combines semantic and keyword retrieval with automatic score fusion.' },
      { letter: 'B', text: 'Build two separate retrieval pipelines (one semantic, one keyword) and alternate between them based on query type.' },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'B', text: 'Use different data sources within the same Knowledge Base — one with semantic chunking for manuals and one with fixed-size chunking for FAQs.' },
      { letter: 'C', text: 'Increase the maximum chunk size parameter for semantic chunking to make FAQ chunks larger.' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Catastrophic forgetting — the fine-tuning process overwrote the model\'s general knowledge with the narrow support domain.' },
      ...
      { letter: 'D', text: 'The fine-tuning dataset contained too many examples, causing overfitting to the training data format.' }
    ],
    correct: ['A'],
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Amazon Titan Text Embeddings V2 with 1024 dimensions.' },
      { letter: 'B', text: 'Amazon Titan Multimodal Embeddings G1 to handle both text and images.' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Enable S3 server-side encryption with a customer-managed KMS key (SSE-KMS). Use Amazon Bedrock model customization, which processes data within the same Region by default.' },
      { letter: 'B', text: 'Enable S3 client-side encryption before upload. Configure Bedrock to decrypt the data during training.' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Use Amazon Bedrock\'s built-in parsing with the foundation model parser option to extract and preserve table structures during ingestion.' },
      { letter: 'B', text: 'Convert all PDFs to plain text before uploading to S3.' },
      { letter: 'C', text: 'Increase the chunk overlap to 50% to ensure table data appears in multiple chunks.' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Define an action group with an API schema (OpenAPI) that points to a Lambda function calling the inventory REST API.' },
      { letter: 'B', text: 'Associate the product catalog Knowledge Base with the Bedrock Agent.' },
      { letter: 'C', text: 'Create a custom orchestration Lambda that calls both the REST API and Knowledge Base sequentially.' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Use continued pre-training with the unlabeled Spanish email corpus to improve the model\'s Spanish language understanding, then use few-shot prompting for classification.' },
      ...
      { letter: 'D', text: 'Increase the temperature parameter to make the model more creative with Spanish text.' }
    ],
    correct: ['A'],
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Set maxTokens to 150 to hard-limit the response length.' },
      { letter: 'B', text: 'Set temperature to 0 to make responses more concise.' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Amazon Bedrock Knowledge Bases — it provides a fully managed pipeline for ingestion, chunking, embedding, storage, and retrieval with no infrastructure to manage.' },
      { letter: 'B', text: 'Custom LangChain on EC2 — it provides more flexibility to customize each step of the RAG pipeline.' },
      { letter: 'C', text: 'Amazon Bedrock Knowledge Bases — but only because it is less expensive per query than EC2.' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'The conversation history is exceeding the model\'s context window. The developer needs to implement conversation summarization or a sliding window over the message history.' },
      ...
      { letter: 'D', text: 'The maxTokens parameter is too low, preventing the model from reading the full conversation.' }
    ],
    correct: ['A'],
  ...
  // ─── Domain 2: Implementation & Integration (20 questions, IDs 24–43) ───
  {
    ...
    options: [
      { letter: 'A', text: 'The application code is using the base model ID instead of the provisioned model ARN in the InvokeModel requests.' },
      { letter: 'B', text: 'Provisioned Throughput only applies to the Converse API, not InvokeModel.' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Use Provisioned Throughput for guaranteed capacity and select a fast model like Claude Haiku. Enable response streaming with InvokeModelWithResponseStream to deliver partial results immediately.' },
      ...
      { letter: 'C', text: 'Deploy the model on a SageMaker real-time endpoint with auto-scaling.' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Use AWS Step Functions with a Map state to process documents in parallel. Each map iteration runs a sequential chain of Lambda functions (classify → summarize → translate) calling Amazon Bedrock.' },
      ...
      { letter: 'D', text: 'Use Amazon EMR with a Spark job that calls Bedrock for each document transformation.' }
    ],
    correct: ['A'],
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Create a VPC endpoint (PrivateLink) for Amazon Bedrock Runtime and configure the Lambda function\'s security group to allow outbound traffic to the endpoint.' },
      { letter: 'B', text: 'Add a NAT Gateway to the VPC and route traffic to the public Bedrock endpoint.' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'The Amazon Bedrock Converse API, which provides a unified interface across all supported models.' },
      { letter: 'B', text: 'The Amazon Bedrock InvokeModel API with provider-specific request bodies for each model.' },
      { letter: 'C', text: 'The Amazon Bedrock CreateModelCustomizationJob API to create a unified custom model.' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Use the InvokeModelWithResponseStream API or the Converse API with streaming enabled to deliver tokens as they are generated.' },
      ...
      { letter: 'D', text: 'Cache common responses in Amazon ElastiCache to avoid calling Bedrock for repeated questions.' }
    ],
    correct: ['A'],
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Associate the IT documentation Knowledge Base with the agent.' },
      { letter: 'B', text: 'Create an action group with an OpenAPI schema for the Jira ticket creation API and a Lambda function handler.' },
      { letter: 'C', text: 'Create two separate agents — one for Knowledge Base search and one for Jira — and chain them together.' },
      { letter: 'D', text: 'Store the Jira API key in the Knowledge Base as a searchable document.' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Create an Amazon Bedrock Knowledge Base with an S3 data source and OpenSearch Serverless vector store. Use the Retrieve API for search.' },
      { letter: 'B', text: 'Deploy an open-source vector database on Amazon ECS and build a custom ingestion pipeline with Lambda.' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Create a Prompt Flow with three nodes: a Knowledge Base retrieval node, a prompt node for generation, and a Lambda node for validation — connected sequentially.' },
      { letter: 'B', text: 'Create three separate Bedrock Agents and chain them together using Amazon EventBridge.' },
      { letter: 'C', text: 'Use a single prompt with instructions to perform all three steps internally.' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Enable Amazon Bedrock model invocation logging to Amazon CloudWatch. Use CloudWatch Metrics with dimensions for each team to track token counts.' },
      ...
      { letter: 'D', text: 'Use AWS Cost Explorer tags to attribute Bedrock costs to each team.' }
    ],
    correct: ['A'],
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Configure an Amazon Bedrock Guardrail with a denied topics policy that filters out competitor brand names from both input and output.' },
      { letter: 'B', text: 'Add a system prompt instruction: "Never mention competitor brands."' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Amazon Bedrock Agents with action groups for data extraction and database lookup, using the agent\'s built-in orchestration.' },
      { letter: 'B', text: 'AWS Step Functions with sequential Lambda tasks for each processing step.' },
      { letter: 'C', text: 'Amazon SQS with three separate queues and Lambda consumers.' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'On-demand inference shares capacity across customers. Variable load from other users causes inconsistent latency. Provisioned Throughput would provide more consistent performance.' },
      ...
      { letter: 'D', text: 'Different AWS Regions have different processing speeds for the same model.' }
    ],
    correct: ['A'],
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Implement a prompt chain in the application code: call the Converse API three times sequentially, passing each output as input to the next call.' },
      { letter: 'B', text: 'Use a single Converse API call with a very detailed system prompt that instructs the model to draft, critique, and finalize in one response.' },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'B', text: 'Use the Amazon Bedrock Converse API which has a similar message-based interface, and update the SDK client and model ID references.' },
      { letter: 'C', text: 'Deploy a proxy layer that translates OpenAI API format to Bedrock API format so the application code remains unchanged.' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Store the conversation message history in Amazon DynamoDB keyed by a session ID. On each new request, load the history from DynamoDB and pass it to the Converse API.' },
      ...
      { letter: 'D', text: 'Configure an Amazon ElastiCache Redis cluster to store conversation state with TTL expiration.' }
    ],
    correct: ['A'],
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Create a custom Control Tower guardrail (SCP-based) that denies Bedrock actions and apply it to the sandbox OU.' },
      { letter: 'B', text: 'Modify the Control Tower landing zone configuration to disable Bedrock globally, then add exceptions for production accounts.' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'AWS Lake Formation with fine-grained access control policies that restrict access at the row and column level.' },
      { letter: 'B', text: 'Amazon S3 bucket policies with prefix-based access restrictions for each team.' },
      { letter: 'C', text: 'AWS IAM policies attached to each team\'s roles with resource-level permissions on S3 objects.' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Amazon Bedrock Guardrails with denied topics for medical diagnoses and prescriptions, plus PII filters for patient names.' },
      ...
      { letter: 'D', text: 'Amazon Comprehend Medical to filter the model\'s output for medical entities before returning to the user.' }
    ],
    correct: ['A'],
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Amazon Bedrock model invocation logging with full request and response logging to Amazon S3 and CloudWatch Logs.' },
      { letter: 'B', text: 'AWS CloudTrail data events for Amazon Bedrock to capture all API calls.' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Apply Amazon Bedrock Guardrails with input content filters and denied topics. Additionally, validate and sanitize user inputs in the application layer before sending to the model.' },
      { letter: 'B', text: 'Make the system prompt very long and complex so attackers cannot guess its structure.' },
      { letter: 'C', text: 'Set the temperature to 0 to prevent the model from following unexpected instructions.' },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'B', text: 'Create VPC endpoints for Bedrock Runtime and configure security groups to restrict access to authorized VPC resources only.' },
      { letter: 'C', text: 'Purchase a Bedrock Enterprise license that includes automatic SOC 2 certification.' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'One Guardrail with three policy types: denied topics for competitors, word filters for profanity, and sensitive information filters for PII.' },
      ...
      { letter: 'D', text: 'Three separate Guardrails combined into a Guardrail chain via Amazon EventBridge.' }
    ],
    correct: ['A'],
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Create IAM policies with Condition keys that restrict bedrock:InvokeModel to specific model IDs. Attach the Claude-only policy to Team A\'s role and the Titan-only policy to Team B\'s role.' },
      { letter: 'B', text: 'Create separate AWS accounts for each team — one with only Claude enabled and one with only Titan enabled.' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Use Amazon Bedrock model evaluation to run automated assessments against test datasets, supplemented with human evaluation for subjective quality criteria.' },
      { letter: 'B', text: 'Deploy to production with monitoring and fix issues as they are reported by users.' },
      { letter: 'C', text: 'Run the application through Amazon Inspector to identify security vulnerabilities.' },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: 'Amazon SageMaker ML Lineage Tracking to record the relationships between datasets, models, and endpoints.' },
      { letter: 'D', text: 'AWS Config to record resource configuration changes across the pipeline.' }
    ],
    correct: ['C'],
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Enable Bedrock model invocation logging to an S3 bucket configured with S3 Object Lock in compliance mode with a 7-year retention period.' },
      { letter: 'B', text: 'Enable Bedrock model invocation logging to CloudWatch Logs with a 7-year retention period.' },
  ...
  // ─── Domain 4: Operational Efficiency (9 questions, IDs 59–67) ───
  {
    ...
    options: [
      { letter: 'A', text: 'Use Amazon Bedrock Prompt Management to create, version, and manage all prompts centrally. Use prompt ARNs in application code to reference specific versions.' },
      { letter: 'B', text: 'Store all prompts in a shared Amazon S3 bucket organized by team and version folders.' },
      { letter: 'C', text: 'Use AWS Systems Manager Parameter Store to store prompt strings as secure parameters.' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Use Amazon Bedrock model evaluation with both automatic evaluation (using a judge model) and human evaluation workflows to compare the two prompt versions against a test dataset.' },
      ...
      { letter: 'D', text: 'Run both prompts through Amazon Comprehend sentiment analysis and choose the one with higher positive sentiment scores.' }
    ],
    correct: ['A'],
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Set up periodic automated evaluation using Amazon Bedrock model evaluation against a curated test dataset. Create CloudWatch alarms on evaluation scores dropping below thresholds.' },
      { letter: 'B', text: 'Monitor CloudWatch metrics for Bedrock API latency and error rates.' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Implement a caching layer using Amazon ElastiCache that stores prompt-response pairs. Check the cache before calling Bedrock and return cached responses for identical prompts.' },
      { letter: 'B', text: 'Use Amazon Bedrock batch inference to process all documents at once for a volume discount.' },
      { letter: 'C', text: 'Reduce the maxTokens parameter to generate shorter responses.' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Create a Bedrock model evaluation job with both models selected, provide the test dataset in JSONL format, and configure automatic evaluation with accuracy metrics.' },
      ...
      { letter: 'D', text: 'Use Amazon SageMaker Clarify to run bias and accuracy analysis on both models.' }
    ],
    correct: ['A'],
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Use Amazon Bedrock batch inference to process all translations as an asynchronous batch job.' },
      ...
      { letter: 'D', text: 'Use Amazon Translate instead of Bedrock for pure translation tasks.' }
    ],
    correct: ['D'],
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Use Amazon Bedrock\'s built-in model customization job metadata which records the base model, training data S3 path, and hyperparameters for each job.' },
      { letter: 'B', text: 'Maintain a spreadsheet listing all model versions and their configurations.' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Use AWS Cost Explorer with filters for the Bedrock service and group by tags (application, team) to identify which tagged resources have the highest cost.' },
      { letter: 'B', text: 'Review Amazon Bedrock model invocation logs to count API calls per application.' },
      { letter: 'C', text: 'Check AWS Budgets to see which budget was exceeded.' },
  ...
  // ─── Domain 5: Testing & Troubleshooting (8 questions, IDs 68–75) ───
  {
    ...
    options: [
      { letter: 'A', text: 'Check whether the retrieval step returns sufficient relevant chunks by examining the retrieved passages. Increase the number of retrieved chunks and test with hybrid search.' },
      ...
      { letter: 'D', text: 'Lower the temperature to make the model more focused and deterministic.' }
    ],
    correct: ['A'],
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'The training and test datasets are not representative of production data distribution. The model is overfitting to the training data characteristics.' },
      { letter: 'B', text: 'The production data volume is too high, causing the model to make errors under load.' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Review the OpenAPI schema descriptions for each action. Ensure the operation descriptions clearly differentiate when each action should be used.' },
      { letter: 'B', text: 'Switch to a more capable foundation model for the agent.' },
      { letter: 'C', text: 'Add more action groups to give the agent more options to choose from.' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Review the Guardrail trace logs to see which specific filter or topic is triggering the blocks, then adjust the filter strength or refine the denied topic definitions.' },
      ...
      { letter: 'D', text: 'Switch to a different foundation model that is less likely to trigger Guardrail filters.' }
    ],
    correct: ['A'],
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Check if the model ID being used has been deprecated or if the model\'s input format requirements have changed in a recent Bedrock service update.' },
      { letter: 'B', text: 'Check the application\'s AWS credentials and IAM permissions to ensure they haven\'t expired or been modified.' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: 'Gradually increase the number of concurrent requests while monitoring Bedrock API latency, error rates, and throttling metrics in CloudWatch. Identify the point where latency exceeds 5 seconds or throttling begins.' },
      { letter: 'B', text: 'Send the maximum expected number of concurrent requests all at once and check if any fail.' },
      { letter: 'C', text: 'Test with a single request and multiply the response time by the expected concurrent users.' },
